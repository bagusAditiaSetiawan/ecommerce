                ...
                <div class="header-section">
                    ...
                    <div class="logo">
                        <a href="index.html">
                            <span class="logo-img">
                                <img src="<?php echo base_url('admin');?>/assets/images/logo_sm.png" alt="" height="26">
                            </span>
                            ...
                            <ul class="notification-menu">
                                    ...
                                    <ul class="dropdown-menu mailbox dropdown-menu-right">
                                        ...
                                        <li class="notification-scroll">
                                            <div class="message-center">
                                                <a href="#">
                                                    <div class="user-img">
                                                         <img src="<?php echo base_url('admin');?>/assets/images/users/avatar-2.jpg" alt="user" class="rounded-circle"> 
                                                ...
                                                <a href="#">
                                                    <div class="user-img">
                                                        <img src="<?php echo base_url('admin');?>/assets/images/users/avatar-4.jpg" alt="user" class="rounded-circle"> 
                                                ...
                                                <a href="#">
                                                    <div class="user-img"> 
                                                        <img src="<?php echo base_url('admin');?>/assets/images/users/avatar-5.jpg" alt="user" class="rounded-circle"> 
                                ...
                                <li>
                                    <a href="javascript:;" data-toggle="dropdown">
                                        <img src="<?php echo base_url('admin');?>/assets/images/users/avatar-1.jpg" alt="">
                                    </a>
